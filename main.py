"""Модуль настройки персонажа, позволяет выбрать имя
и класс. Также импортирован графический модуль заставки."""
...
def attack(char_name: str, char_class: str) -> str:
    """Рассчитывает урон от атаки в зависимости от выбранного класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Рассчитывает количество заблокированного урона в
...
def special(char_name: str, char_class: str) -> str:
    """Количественно отображает эффект специальной способности в
    зависимости от класса."""
    if char_class == 'warrior':
